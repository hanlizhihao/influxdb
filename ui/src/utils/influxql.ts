...
import {AUTO_GROUP_BY, TEMP_VAR_INTERVAL} from 'src/shared/constants'
import {NULL_STRING} from 'src/shared/constants/queryFillOptions'
import {TYPE_FLUX, TYPE_QUERY_CONFIG, TYPE_SHIFTED,} from 'src/dashboards/constants'
import {shiftTimeRange} from 'src/shared/query/helpers'
import {Field, GroupBy, QueryConfig, TimeRange, TimeShift} from 'src/types'
