import {LogViewerView, ViewShape, ViewType} from 'src/types/v2/dashboards'
import {SeverityColorOptions, SeverityColorValues, SeverityLevelOptions, TableData,} from 'src/types/logs'
