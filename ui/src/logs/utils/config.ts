...
import {LogViewerColumn, LogViewerColumnSetting, LogViewerView, NewView, View,} from 'src/types/v2/dashboards'

import {DEFAULT_TRUNCATION, EMPTY_VIEW_PROPERTIES, LOG_VIEW_NAME,} from 'src/logs/constants'
