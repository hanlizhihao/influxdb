// Reducer
import dataLoadersReducer, {INITIAL_STATE,} from 'src/onboarding/reducers/dataLoaders'
// Actions
import {
    addConfigValue,
    addPluginBundle,
...
import {BundleName, ConfigurationState, DataLoaderType, TelegrafPlugin,} from 'src/types/v2/dataLoaders'
