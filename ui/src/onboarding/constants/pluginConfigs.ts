// Types
import {BundleName, ConfigFieldType, TelegrafPluginInfo, TelegrafPluginName,} from 'src/types/v2/dataLoaders'
import {
...
import {LogoCpu, LogoDocker, LogoKubernetes, LogoNginx, LogoRedis,} from 'src/onboarding/graphics'
